...
public class UniversalMusicWidget_4x2 extends AppWidgetProvider {
	...
	public void onDeleted(Context context, int[] appWidgetId) {
		 ...
		 * intnt.putExtra("STATE", "MEDIUM_DELETED");
	...
	public void create(Context cntxt) {
		...
		views = new RemoteViews(context.getApplicationContext()
				.getPackageName(), R.layout.main_4x2);
		...
		appWidgetIds = new ComponentName(context.getApplicationContext(),
				UniversalMusicWidget_4x2.class);
	...
	private void buttonListeners() {
		...
		PendingIntent OpenSettings = PendingIntent.getBroadcast(context, 0,
				new Intent("com.voiche.universalmusicwidget_4x2.OPENSETTINGS"),
				0);
	...
	private void adjustUI() {
		...
		String bgrcolor = (shared.getString("bgrcolor", "-15000541"));// (16777215)-1509949440-15000541
																		// for
																		// normal
		String fontcolor = shared.getString("fontcolor", "-1");
		String tnfontcolor = shared.getString("tnfontcolor", "-1");
		String fontsize = shared.getString("fontsize", "14");// (14)12 for
																// normal
		String tnfontsize = shared.getString("tnfontsize", "17");// (16)14 for
																	// normal
		String buttons = (shared.getString("buttons", "3"));// (2)1 for normal
		daa = shared.getString("daa", "true");
		String dan = shared.getString("dan", "true");
		...
		views.setFloat(R.id.album, "setTextSize", Float.parseFloat(fontsize));
	...
	public void updateButtons(boolean bool) {
		...
		if (buttonType == 0) {
			String buttons = (shared.getString("buttons", "3"));// (2)1-for-normal-3-for-medium
			buttonType = Integer.parseInt(buttons);
		}
