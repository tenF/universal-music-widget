...
public class UniversalMusicWidget_4x4 extends AppWidgetProvider {
	...
	public void onDeleted(Context context, int[] appWidgetId) {
		 ...
		 * intnt.putExtra("STATE", "XLARGE_DELETED");
	...
	public void create(Context cntxt) {
		...
		views = new RemoteViews(context.getApplicationContext()
				.getPackageName(), R.layout.main_4x4);
		...
		appWidgetIds = new ComponentName(context.getApplicationContext(),
				UniversalMusicWidget_4x4.class);
	...
	private void buttonListeners() {
		...
		PendingIntent OpenSettings = PendingIntent.getBroadcast(context, 0,
				new Intent("com.voiche.universalmusicwidget_4x4.OPENSETTINGS"),
				0);
	...
	private void adjustUI() {
		...
		String bgrcolor = (shared.getString("bgrcolor", "-15000541"));// (16777215)-1509949440
																		// for
																		// normal
		...
		String fontsize = shared.getString("fontsize", "14");// (14)12 for
																// normal
		String tnfontsize = shared.getString("tnfontsize", "16");// (16)14 for
																	// normal
